...
import { Notification } from '../../../infrastructure/notifications/NotificationService';
  ...
  return (
    <div
      ...
      className={`
        ...
        border rounded-lg shadow-lg p-4 mb-3 flex items-start gap-3 min-w-[320px] max-w-md
